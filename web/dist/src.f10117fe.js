...
function () {
  ...
  User.prototype.save = function () {
    ...
    if (this.get('id')) {
      // put
      axios_1.default.put(BASE_URL + "/" + id, this.data).then(function (response) {
        console.log(response.data);
      });
    } else {
      // post
      axios_1.default.post("" + BASE_URL, this.data).then(function (response) {
        console.log(response.data);
      });
    }
  };
...
var User_1 = require("./models/User"); // const user = new User({ name: "New record", age: 1 })
// user.fetch();
// user.set({ name: 'Romeo', age: 25 })
// user.save();


var updateUser = new User_1.User({
  id: 6
});
updateUser.set({
  name: 'Savage 21',
...
},{"./models/User":"src/models/User.ts"}],"../../../.nvm/versions/node/v12.11.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
